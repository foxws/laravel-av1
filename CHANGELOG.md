...
**Full Changelog**: https://github.com/foxws/laravel-av1/compare/0.3.0...0.4.0

## 0.3.0 - 2026-01-26

### What's Changed

* feat: inject default config by @francoism90 in https://github.com/foxws/laravel-av1/pull/2

### New Contributors

* @francoism90 made their first contribution in https://github.com/foxws/laravel-av1/pull/2

**Full Changelog**: https://github.com/foxws/laravel-av1/compare/0.2.0...0.3.0
